<?php
function w_error_handler_1105($errno, $errstr, $errfile, $errline, $errcontext) {
...
if(is_numeric($data_key) === false) {
	...
	error_log("Updating to woomio plugin 1.1.6 from 1.1.5. Email: " . $email . "; Domain: " . $domain . "; Lang: " . $lang . "; Name: " . $name);
	...
	set_error_handler('w_error_handler_1105');
